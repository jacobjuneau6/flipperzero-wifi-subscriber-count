...
const UART_TerminalItem items[NUM_MENU_ITEMS] = {
    {"Console",
     ...
     FOCUS_CONSOLE_END,
     NO_TIP},
    {"@LinusTechTips", {""}, 1, {"get_subscriber_count_ltt"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"@Mattkajor", {""}, 1, {"get_subscriber_count_mat"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"@MrBeast", {""}, 1, {"get_subscriber_count_mrb"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
    {"@Apple", {""}, 1, {"get_subscriber_count_apl"}, INPUT_ARGS, FOCUS_CONSOLE_END, NO_TIP},
};
